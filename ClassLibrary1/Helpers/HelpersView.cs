...
namespace BIMBOX.Revit.Tuna.Helpers
{
    class HelpersView
    {
        ...
        public static void CreateViewport(Document doc, ViewSheet sheet, ref List<Viewport> viewports, Autodesk.Revit.DB.View view)
        {
            // Create viewports
        ...
        /// <param name="annoCategories"></param>
        /// <returns></returns>
        public static Autodesk.Revit.DB.View CreateViewElevation(Document doc, ElevationMarker marker, Autodesk.Revit.DB.View floorPlan, int i,
                                            Autodesk.Revit.DB.View viewTemplate, List<ElementId> annoCategories)
        {
            // Create view elevation
            Autodesk.Revit.DB.View view = marker.CreateElevation(doc, floorPlan.Id, i);
